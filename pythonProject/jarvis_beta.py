...
class Jarvis:
    ...
    def __init__(self):
        ...
        self.engine.setProperty("language", 'hi')
        self.engine.setProperty('voice', voices[3].id)
        self.engine.setProperty('rate', 185)
        self.engine.say(" नमस्ते दुनिया")
    ...
    def current_time(self):
        ...
        time_dictionary = {1: 'एक', 2: 'दो', 3: 'तीन', 4: 'चार', 5: 'पाँच', 6: 'छः', 7: 'सात', 8: 'आठ', 9: 'नौ',
    ...
    def bye(self):
        global mic_btn
        img3 = ImageTk.PhotoImage(PIL.Image.open('mic.png'))
        ...
        playsound.playsound("mixi.wav", True)
        time.sleep(1)
    ...
    def play_music(self):
        ...
        os.chdir(r'C:/Users/abhin/Music')
        music_list = os.listdir()
        choice = randint(0, len(music_list) - 1)
        song = r'C:/Users/abhin/Music/Music0'
        print(song)
...
jarvis = PhotoImage(file="mic.png")
...
def main_win():
    ...
    # image of mic
    img1 = ImageTk.PhotoImage(PIL.Image.open('mic.png'))
    img2 = ImageTk.PhotoImage(PIL.Image.open('mic.png'))

    # button to speak to Jarvis
    mic_btn = Button(win, image=img1, bg='black', relief='flat', activebackground='black', borderwidth=0,
                     command=threading.Thread(target=model.main).start)
